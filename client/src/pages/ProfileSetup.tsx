              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    ...
                    <div className="relative group">
                      <div
                        onClick={() => setFormData({ ...formData, preferredTheme: 'theme3' })}
                        className={`cursor-pointer rounded-lg overflow-hidden border-4 transition-all hover:scale-105 hover:shadow-lg ${
                          formData.preferredTheme === 'theme3'
                            ? 'border-green-500 shadow-xl'
                            : 'border-gray-200 hover:border-blue-300'
                        }`}
                      >
                      ...
                      <Button
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          setPreviewTheme({ type: 'evidence', value: 'theme3', name: 'ثيم الشواهد 3', image: '/themes/evidences/evidence-theme3.png' });
                        }}
                      >
                        <ZoomIn className="w-4 h-4 ml-1" />
                        معاينة
